...
function ReviewStep({ name, habit, commitmentDate, failureConsequence, successConsequence, onBack, onSubmit, isModalOpen, setIsModalOpen, handleSubmit }) {
    ...
    return (
        <>
            ...
            <button onClick={onSubmit}>Track Your One Habit</button>
        </>
    )
}
